...
<head>
	...
	<title>Technical Council | IITGN</title>
...
<body>
					...
					<nav class="navbar navbar-default">
						<div class="container-fluid nav-bar">
						    <div class="navbar-header">
						      ...
						      <a href="index.html"><img src="{!! asset('img/home/logo.png') !!}" alt="" class="img-responsive logo"></a>
						    </div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-6 banner-img wow fadeInRight animated">
					<img class="img-responsive" src="{!! asset('img/home/verticle-phone.png') !!}" alt="">
				</div>
			</div>
		</div>
	...
	<section class="features text-center" id="features">
		<div class="container">
			<div class="row">
				...
				<img class="img-responsive" src="{!! asset('img/home/daag.png') !!}" alt="">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-5 col-xs-6 col-sm-6 wow slideInUp animated">
					<img class="img-responsive details-phone" src="{!! asset('img/home/verticle-phone.png') !!}" alt="">
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-5 wow fadeInLeft animated">
					...
					<img src="{!! asset('img/home/daag.png') !!}" alt="">
				...
				<div class="col-xs-7 horizontal-phone wow fadeInRight animated">
					<img class="img-responsive" src="{!! asset('img/home/laid-phone2.png') !!}" alt="phone">
				</div>
			</div>
		</div>
					  ...
					  <div class="carousel-inner" role="listbox">
					    <div class="item active">
						    <div class="col-md-6 col-xs-12 col-sm-6 wow zoomIn animated">
						      	...
						      	<div class="person">
						      		<img class="img-circle img-responsive" src="{!! asset('img/home/slider-img-1.jpg') !!}" alt="">
						      		<h6>John Doe</h6>
						    ...
						    <div class="col-md-6 col-xs-12 col-sm-6 wow zoomIn animated">
						      	...
						      	<div class="person">
						      		<img class="img-circle img-responsive" src="{!! asset('img/home/slider-img-2.jpg') !!}" alt="">
					    ...
					    <div class="item">
						    <div class="col-md-6 col-xs-12 col-sm-6 wow zoomIn animated">
						      	...
						      	<div class="person">
						      		<img class="img-circle img-responsive" src="{!! asset('img/home/slider-img-3.jpg') !!}" alt="">
						      		<h6>John Doe</h6>
						      		<h5>CEO, THE RIVERS COMPANY</h5>
						      	</div>
						    </div>
						    <div class="col-md-6 col-xs-12 col-sm-6 wow zoomIn animated">
						      	<p>A shoe is not only a design, but it's a part of your body language, the way you walk. The way you're going to move is quite dictated by your shoes.</p>
						      	<div class="person">
						      		<img class="img-circle img-responsive" src="{!! asset('img/home/slider-img-5.jpg') !!}" alt="">
						      		<h6>Dean Winchester</h6>
						      		<h5>UX DESIGNER, GOOGLE INC.</h5>
						      	</div>
						    </div>
					    ...
					    <div class="item">
						    <div class="col-md-6 col-xs-12 col-sm-6 wow zoomIn animated">
						      	<p>Once upon a time all the Rivers combined to protest against the action of the Sea in making their waters salt. “When we come to you,” said they to the Sea.</p>
						      	<div class="person">
						      		<img class="img-circle img-responsive" src="{!! asset('img/home/slider-img-4.jpg') !!}" alt="">
						      		<h6>John Doe</h6>
						      		<h5>CEO, THE RIVERS COMPANY</h5>
						      	</div>
						    </div>
						    <div class="col-md-6 col-xs-12 col-sm-6 wow zoomIn animated">
						      	<p>A shoe is not only a design, but it's a part of your body language, the way you walk. The way you're going to move is quite dictated by your shoes.</p>
						      	<div class="person">
						      		<img class="img-circle img-responsive" src="{!! asset('img/home/slider-img-6.jpg') !!}" alt="">
						      		<h6>Dean Winchester</h6>
						      		<h5>UX DESIGNER, GOOGLE INC.</h5>
						      	</div>
						    </div>
	...
	<!-- script tags
	============================================================= -->
	<script src="{!! asset('js/home/jquery-2.1.1.js') !!}"></script>
	...
	<script src="{!! asset('js/home/wow.js') !!}"></script>
	<script src="http://maps.google.com/maps/api/js?sensor=true"></script>
	<script src="{!! asset('js/home/gmaps.js') !!}"></script>
	<script>
	    var map = new GMaps({
	      el: '#map',
	      lat: -12.043333,
